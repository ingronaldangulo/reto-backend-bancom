...
public class PostServiceImpl implements PostService {
    ...
    public PostDto update(PostDto postDto) {
        Optional<PostEntity> usuarioEntityOptional = postRepository.findById(postDto.getId());
        log.info("usuario existe: " + usuarioEntityOptional.isPresent());
        if (usuarioEntityOptional.isPresent()) {
            PostEntity usuarioEntity = mapFieldsUpdated(postDto, usuarioEntityOptional.get());
